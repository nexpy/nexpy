...
.. note:: NeXpy v0.12.7 is now available for `download 
...
.. warning:: NeXpy v0.12 and nexusformat v0.5 are the last versions to support 
             Python 2. There may be some urgent bug fixes in the meantime, but 
